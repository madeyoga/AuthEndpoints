...
2. `POST /account/passkeys/requestOptions` with optional body `{ "email": "..." }`. CSRF required. Identifier-first may reveal passkey presence via `allowCredentials`. Omit `email` for usernameless/discoverable login.
