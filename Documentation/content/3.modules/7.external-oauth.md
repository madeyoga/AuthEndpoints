...
Requires ASP.NET Core Identity (`UserManager` / `SignInManager`) already configured — typically via [AddAuthEndpoints](/getting-started/quick-start). It does **not** call Identity management HTTP APIs; those remain optional alongside External.
