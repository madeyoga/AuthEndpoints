...
To install the AuthEndpoints playbook into *your* app, use `npx skills add madeyoga/AuthEndpoints`. That copies from **`skills/authendpoints`**, not from `.cursor/skills`. Details, Cursor Remote Rule, and this-repo layout: [AI agents](/getting-started/ai-agents).
...
Continue to [Quick start](/getting-started/quick-start) to wire the facade in `Program.cs`. For coding agents, see [AI agents](/getting-started/ai-agents).
